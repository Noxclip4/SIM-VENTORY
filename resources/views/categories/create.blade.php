...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Buat kategori baru untuk mengorganisir produk</p>
    </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0 fw-bold">
            <i class="bi bi-tag me-2"></i>Form Kategori
        </h5>
    </div>
    <div class="card-body">
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          name="description" 
                          rows="4" 
                          placeholder="Jelaskan kategori ini untuk membantu pengguna memahami jenis produk yang termasuk...">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">
                        <i class="bi bi-exclamation-triangle me-1"></i>{{ $message }}
                    </div>
